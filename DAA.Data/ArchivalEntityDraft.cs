...
namespace DAA.Data
{
    public partial class ArchivalEntityDraft
    {
        public ArchivalEntityDraft()
        {
        ...
        public virtual ArchivalEntityDescriptionLevel DescriptionLevelCodeNavigation { get; set; } = null!;
