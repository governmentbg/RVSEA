    ...
    <tr>
      ...
      >
        <div class="d-flex justify-content-between">
          <a href="#!" @click="sortBy(col.prop, col.type)" v-if="col.sortable">
          ...
          <span v-else>{{ typeof col.title == "function" ? col.title() : col.title }}</span>
...
export default {
  ...
  methods: {
    ...
    sortBy(val, type) {
      ...
      this.$emit("sort", { key: val, direction: this.sortDirection, type: this.sortkeyType });
    },
  },
  filters: {
    ...filters,
