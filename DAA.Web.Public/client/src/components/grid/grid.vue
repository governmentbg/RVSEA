    ...
    <div class="row">
        ...
        <div class="py-3 col-md-2" style="display: flex; justify-content: flex-end">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#" @click="exportData('json')">JSON</a></li>
        ...
        <div class="table-responsive" :class="{ noHorizontalScroll: noHorizontalScroll }">
            <table class="table table-hover" :class="gridClass">
                ...
                <tbody v-if="!isLoading">
                    <tr
                        class="pointer"
                        :class="[{ highlighted: row.prop.highlighted }, row.prop?.class || '']"
                ...
                <tr v-if="!isLoading && dataSource.data.length === 0">
                    <td colspan="10000">
                        <div class="text-danger">{{ noDataMessage }}</div>
                    </td>
                </tr>
            </table>
        </div>
...
export default {
    ...
    props: {
        items: Array,
        columns: Array,
        //добавено за да скипва бутоните при row cklick
