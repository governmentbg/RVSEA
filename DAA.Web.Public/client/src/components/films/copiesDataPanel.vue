<template>
    <v-expansion-panel value="general">
        <v-expansion-panel-title>{{ t('films.panels.system') }} </v-expansion-panel-title>
        ...
        <v-expansion-panel-text>
            ...
            <v-row>
                <v-col>
                    <v-col class="col-12">
                        <Switch
                            :label="t('films.columns.inventoryEligibility')"
                            :large="false"
                            :showLabel="true"
                            :disabled="true"
                        />
            ...
            <v-row>
                <v-col class="col-6">
                    <text-area-field :label="t('films.columns.content')" v-model="model.content" :readonly="true" />
                </v-col>
                <v-col class="col-6">
                    <text-area-field
                        name="fldNotes"
