...
CREATE DATABASE [DAA.BufferFiles]
CONTAINMENT = NONE
ON PRIMARY ( NAME = N'DAA.BufferFiles', FILENAME = N'D:\Database.SQL2019\DAA.BufferFiles.mdf', SIZE = 51200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10240KB ), 
FILEGROUP [FILESTREAM_GROUP] CONTAINS FILESTREAM ( NAME = N'fsBufferFiles', FILENAME = N'D:\DAA\bufferfiles' , MAXSIZE = UNLIMITED)
LOG ON ( NAME = N'DAA.BufferFiles_Log', FILENAME = N'D:\Database.SQL2019\DAA.BufferFiles_log.ldf' , SIZE = 51200KB , MAXSIZE = 2048GB , FILEGROWTH = 10240KB )
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
BEGIN
	EXEC [DAA.BufferFiles].[dbo].[sp_fulltext_database] @action = 'enable'
END
GO
...
ALTER DATABASE [DAA.BufferFiles]  
SET FILESTREAM ( NON_TRANSACTED_ACCESS = FULL, DIRECTORY_NAME = N'DAABufferFiles' )
GO
