...
{
    public partial class AdjunctFileContext : DbContext
    {
        public AdjunctFileContext()
        {
        }

        public AdjunctFileContext(DbContextOptions<AdjunctFileContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("name=AdjunctFilesConnection");
            }
        }
