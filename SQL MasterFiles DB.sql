...
CREATE DATABASE [DAA.MasterFiles]
CONTAINMENT = NONE
ON PRIMARY ( NAME = N'DAA.MasterFiles', FILENAME = N'D:\Database.SQL2019\DAA.MasterFiles.mdf', SIZE = 51200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10240KB ), 
FILEGROUP [FILESTREAM_GROUP] CONTAINS FILESTREAM ( NAME = N'fsMasterFiles', FILENAME = N'D:\DAA\Masterfiles' , MAXSIZE = UNLIMITED)
LOG ON ( NAME = N'DAA.MasterFiles_Log', FILENAME = N'D:\Database.SQL2019\DAA.MasterFiles_log.ldf' , SIZE = 51200KB , MAXSIZE = 2048GB , FILEGROWTH = 10240KB )
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
BEGIN
	EXEC [DAA.MasterFiles].[dbo].[sp_fulltext_database] @action = 'enable'
END
GO
...
ALTER DATABASE [DAA.MasterFiles]  
SET FILESTREAM ( NON_TRANSACTED_ACCESS = FULL, DIRECTORY_NAME = N'DAAMasterFiles' )
GO
...
--SET ( FILETABLE_DIRECTORY = N'FileContent' );  
--GO
