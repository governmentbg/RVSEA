...
namespace DAA.Identity
{
        ...
        IQueryableUserStore<ApplicationUser>
    {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        Task AddToRoleAsync(ApplicationUser user, Guid roleId, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        Task RemoveFromRoleAsync(ApplicationUser user, Guid roleId, CancellationToken cancellationToken);
        ...
        Task<IList<Guid>> GetRolesIdentifiersAsync(ApplicationUser user, CancellationToken cancellationToken);
        ...
        /// a member of the named role.
        /// </returns>
        Task<bool> IsInRoleAsync(ApplicationUser user, Guid roleId, CancellationToken cancellationToken);
        ...
        /// The <see cref="Task"/> that represents the asynchronous operation, containing a list of users who are in the named role.
        /// </returns>
        Task<IList<ApplicationUser>> GetUsersInRoleAsync(Guid roleId, CancellationToken cancellationToken);
    }
}
