...
CREATE DATABASE [DAA.Files]
CONTAINMENT = NONE
ON PRIMARY ( NAME = N'DAA.Files', FILENAME = N'D:\Database.SQL2019\DAA.Files.mdf', SIZE = 51200KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10240KB ), 
FILEGROUP [FILESTREAM_GROUP] CONTAINS FILESTREAM ( NAME = N'fsFiles', FILENAME = N'D:\DAA\files' , MAXSIZE = UNLIMITED)
LOG ON ( NAME = N'DAA.Files_Log', FILENAME = N'D:\Database.SQL2019\DAA.Files_log.ldf' , SIZE = 51200KB , MAXSIZE = 2048GB , FILEGROWTH = 10240KB )
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
BEGIN
	EXEC [DAA.Files].[dbo].[sp_fulltext_database] @action = 'enable'
END
GO
...
ALTER DATABASE [DAA.Files]  
SET FILESTREAM ( NON_TRANSACTED_ACCESS = FULL, DIRECTORY_NAME = N'DAAFiles' )
GO
