<template>
    ...
    <v-card-text> -->
        <v-card class="col-12 col-md-9 col-lg-9 ma-auto">
            <div>
                <h3 class="display-6">{{ t('reports.memoriesList') }}</h3>
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const viewReport = (options: GridOptions) => {
            ...
            exportParams.value = ReportType.fundMemoriesList;

            reportService
                .getFundMemoriesListReport(gridInputModel)
                .then(
                    (
        ...
        const gridItems = ref([] as FundMemoriesListReport[]);
        const headers = ref([
            {
