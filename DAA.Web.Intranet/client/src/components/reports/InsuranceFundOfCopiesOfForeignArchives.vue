<template>
    ...
    <v-card-text> -->
        <v-card class="col-12 col-md-9 col-lg-9 ma-auto">
            <div>
                <h3 class="display-6">{{ t('reports.insuranceFundOfCopiesOfForeignArchives') }}</h3>
...
export default defineComponent({
    name: 'InsuranceFundOfCopiesOfForeignArchives',
    emits: ['loadingChange'],
    props: {
        isCanceled: {
            type: Boolean,
    ...
    setup(props, { emit }) {
        ...
        const viewReport = (options: GridOptions) => {
            ...
            exportParams.value = ReportType.insuranceFundOfCopiesOfForeignArchives;

            reportService
                .getInsuranceFundOfCopiesOfForeignArchives(gridInputModel)
                .then(
                    (
                        result: ReportServiceResultModel<
                            ReportGridResponseModel<InsuranceFundOfCopiesOfForeignArchives>
                        >
                    ) => {
        ...
        const gridItems = ref([] as InsuranceFundOfCopiesOfForeignArchives[]);
        const headers = ref([
            {
            ...
            {
                title: t('reports.microfilmNegativeRollsCount'),
                prop: 'copyNegativeRolls',
                type: 'int',
            },
            {
                title: t('reports.microfilmNegativeFramesCount'),
                prop: 'copyNegativeFrames',
                type: 'int',
            },
            {
                title: t('reports.microfilmPositiveRollsCount'),
                prop: 'copyPositiveRolls',
                type: 'int',
            },
            {
                title: t('reports.microfilmPositiveFramesCount'),
                prop: 'copyPositiveFrames',
                type: 'int',
            },
            {
                title: t('reports.photoXeroxCopy'),
                prop: 'copyXerox',
                type: 'string',
            },
            {
                title: t('reports.digitalImages'),
                prop: 'copyDigital',
                type: 'string',
            },
            {
                title: t('reports.electronicDocumentsCount'),
                prop: 'electronicDocumentsCount',
                type: 'int',
            },
            {
                title: t('reports.electronicDocumentsMB'),
                prop: 'electronicDocumentsSize',
                type: 'int',
            ...
            {
                title: t('reports.doublesNegativeCount'),
                prop: 'doublesNegativeCount',
                type: 'int',
            },
            {
                title: t('reports.doublesNegativeLocation'),
                prop: 'doublesNegativeLocation',
                type: 'string',
            },
            {
                title: t('reports.doublesPositiveCount'),
                prop: 'doublesPositiveCount',
                type: 'int',
            },
            {
                title: t('reports.doublesPositiveLocation'),
                prop: 'doublesPositiveLocation',
                type: 'string',
            },
            {
                title: t('reports.photolabDeliveryDate'),
                prop: 'photolabDeliveryDate',
                type: 'string',
            },
            {
        ...
        const breadcrumbItems = [
            ...
            {
                title: t('reports.insuranceFundOfCopiesOfForeignArchives'),
                disabled: true,
            },
        ];
