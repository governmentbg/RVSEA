<template>
    ...
    <v-card-text> -->
        <v-card class="col-12 col-md-9 col-lg-9 ma-auto">
            <div>
                <h3 class="display-6">{{ t('reports.inventoryBook') }}</h3>
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const viewReport = (options: GridOptions) => {
            ...
            exportParams.value = ReportType.inventoryBook;

            reportService
                .getInventoryBook(gridInputModel)
                .then((result: ReportServiceResultModel<ReportGridResponseModel<InventoryBook>>) => {
        ...
        const gridItems = ref([] as InventoryBook[]);
        const headers = ref([
            {
            ...
            {
                title: t('reports.negatives'),
                prop: 'negatives',
                type: 'string',
            },
            {
                title: t('reports.positives'),
                prop: 'positives',
                type: 'string',
            },
            {
