    ...
    <v-row align="end">
        <v-col class="d-grid gap-2 d-md-flex justify-content-center">
            <confirm-dialog 
                ...
                @confirm="btnReportApprovalStepClickHandler(ProcessStep.RefineData_ReportApproval)"
            />
            ...
            <confirm-dialog 
                ...
                @confirm="(commentInput) => btnReportApprovalStepClickHandler(ProcessStep.RefineData_ReportChangesRequired, commentInput)"
            />
            ...
            <confirm-dialog 
                ...
                :cancelButtonText="t('common.cancel')"
                :commentInputEnabled="true"
                @confirm="(commentInput) => btnReportApprovalStepClickHandler(ProcessStep.RefineData_ReportRejection, commentInput)"
            />
...
export default defineComponent({
    name: 'RefineDataReportApprovalActions',
    components: {
        ConfirmDialog,
    },
    props: {
