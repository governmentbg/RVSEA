<template>
    <div class="pager">
        ...
        <div class="row mx-3 align-items-baseline" style="max-height: 38px;">
            <div class="col-md-5">
            ...
            <div class="col-md-7 text-nowrap" style="max-height: 3px;">{{ $t('grid.pager.rowsOnPage') }}</div>
        </div>
    </div>
</template>
...
export default {
        ...
        changePageSet() {
            if (this.currentPage >= this.firstInPageSet + this.pageSetSize) {
                ...
                if (this.currentPage == this.totalPages) {
                    const minSets = Math.floor(this.totalPages / this.pageSetSize);
                    this.firstInPageSet =
    ...
    computed: {
        currentPageSet() {
            ...
            const firstPage = this.firstInPageSet;
        ...
        showPreviousPageSetButton() {
            const showPrevious = this.firstInPageSet > this.pageSetSize;
            return showPrevious;
        },
        showNextPageSetButton() {
            const showNext = this.firstInPageSet + this.pageSetSize <= this.totalPages;
            return showNext;
        },
    },
    watch: {
