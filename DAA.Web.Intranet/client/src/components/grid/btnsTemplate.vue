<template>
  <div>
    <div v-if="!templateArgs1.showAsDropdown">
      ...
      >
        <span v-if="btn.showBtn === undefined || btn.showBtn(templateArgs)">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          ...
          >
            ...
            >
              <span
                v-if="btn.showBtn === undefined || btn.showBtn(templateArgs)"
              >
                <i v-if="btn.icon" :class="btn.icon"></i>
                {{ btn.text ? btn.text : "" }}
              </span>
...
export default defineComponent({
  ...
  mounted() {
    ...
    if (this.templateArgs1.showAsDropdown) {
      const dropEl = (this.$el as HTMLElement).querySelector(".fa-ellipsis-v");
