    ...
    <div class="py-3">
        ...
        >
            <template v-slot:menubar>
                ...
                <v-btn @click="addUserHandler">{{ t('users.create') }}
                    <v-tooltip
                        activator="parent"
                        location="bottom"
                    >
...
export default defineComponent({
    ...
    setup() {
        ...
        const gridUrl = computed(() =>
            userService.getUsersByProfileTypeUrl(ApplicationUserProfileType.ReaderInReadingRoom)
        );
        ...
        const addUserHandler = () => {
            useRedirect(router, 'CreateReaderUser');
        };
        ...
        const rowButtons = [
            ...
            //   },
            {
                ...
                clickHandler: (item: IUserInfo) => {
                    if (item.id) {
                        useRedirectWithId(router, 'EditReaderUser', item.id);
                    }
                },
            },
            {
