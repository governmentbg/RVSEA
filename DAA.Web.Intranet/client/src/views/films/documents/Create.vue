<template>
    ...
    <v-card class="col-12 col-md-9 col-lg-9 ma-auto">
        <v-card-title class="v-card-title-uppercase">{{ t('filmDocuments.create') }}</v-card-title>
...
import { FilmPackageDocument, FilmPackageDocumentCreateModel } from '@/models/film';
    ...
    setup(props) {
        ...
        const submitFilmDocData = async () => {
            ...
            try {
                ...
                const createModel = new FilmPackageDocumentCreateModel();
                ...
                createModel.skipValidation = props.packageType === 'B' ? skipValidation.value : true;

                const result = await filmDocumentService.createFilmDocument(createModel);
                isBusy.value = false;
