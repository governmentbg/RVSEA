import { IPackageATemplate, PackageATemplateCreateModel, PackageATemplateUpdateModel } from '@/models/packageATemplate';
...
class PackageATemplateService {
    ...
    create(data: PackageATemplateCreateModel): Promise<number> {
        ...
        fd.append('static', data.static!.toString());
    ...
    getEmptyTemplates(packageId: number, processId: number) {
        return http
            .get(`${this.url}/EmptyTemplatesByPackage?packageId=${packageId}&processId=${processId}`)
