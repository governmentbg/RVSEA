...
{
    public class ArchivalEntityImportModel
    {
        ...
        [ExportTemplate("Буквен индекс на архивна единица")]
        ...
        [ExportTemplate("Индекс по класификационната схема")]
        ...
        [ExportTemplate("Заглавие на архивна единица")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "Поле Заглавие на архивна единица трябва да бъде попълнено")]
        ...
        [Required(ErrorMessage = "Поле Начална дата година трябва да бъде попълнено")]
        ...
        [Required(ErrorMessage = "Поле Крайна дата година трябва да бъде попълнено")]
        ...
        public IEnumerable<DocumentImportModel>? Documents { get; set; }
        ...
        public string Number
        {
            get
            {
                return $"{NumberNumeric}{NumberArray ?? String.Empty}".Trim();
            }
        }
        ...
        public List<int> PackageFileIds
        {
            get
            {
                ...
                {
                    return Documents.SelectMany(x => x.PackageFileIds).ToList();
                }
